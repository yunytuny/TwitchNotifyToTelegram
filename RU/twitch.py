...
if os.path.isfile(os.path.join('settings.json')): # Checking if settings file existing
    ...
    print('Файл с настройками не существует, создаём...')
...
if settings['token'] == 'YOUR_OAUTH_TOKEN':
    print('Генерируем новый OAuth токен')
...
while True:
    ...
    if data['data']:
        ...
        print("Отправляем уведомление и уходим в сон на 10 часов")
        ...
        print(f'{streamer} не стримит! Следующая проверка через минуту.')
